...
def main():
    ...
    tokenizer.pad_token = tokenizer.eos_token #emily edited
    # endregion
    ...
    with training_args.strategy.scope():
        ...
        model.config.pad_token_id = model.config.eos_token_id #emily edited
        # endregion
        ...
        if training_args.do_train or training_args.do_predict: #emily edit
            num_train_steps = len(tf_data["test"]) * training_args.num_train_epochs #emily edit
